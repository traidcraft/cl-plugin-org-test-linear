...
| Date | PR | Summary |
|------|-----|---------|
| 2026-03-31 | [#2](knowledge-base/branch-feature-tra-4-add-select-all-deselect-all-checkbox-to-item-grid.md) | Add select-all/deselect-all checkbox to item grid header with indeterminate state |
